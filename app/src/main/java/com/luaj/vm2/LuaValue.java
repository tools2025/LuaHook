...
public class LuaValue extends Varargs {
    ...
    public static final LuaValue NIL = com.luaj.vm2.LuaNil._NIL;
    ...
    public static LuaString ENV = (LuaString) valueOf("_ENV");
    ...
    public LuaNumber checknumber(String msg) {
        throw new com.luaj.vm2.LuaError(msg);
    }
    ...
    public static LuaValue error(String message) {
        throw new com.luaj.vm2.LuaError(message);
    }


    public static void assert_(boolean b, String msg) {
        if (!b) throw new com.luaj.vm2.LuaError(msg);
    }


    protected LuaValue argerror(String expected) {
        throw new com.luaj.vm2.LuaError("bad argument: " + expected + " expected, got " + typename());
    }


    public static LuaValue argerror(int iarg, String msg) {
        throw new com.luaj.vm2.LuaError("bad argument #" + iarg + ": " + msg);
    }


    protected LuaValue typerror(String expected) {
        throw new com.luaj.vm2.LuaError(expected + " expected, got " + typename());
    }


    protected LuaValue unimplemented(String fun) {
        throw new com.luaj.vm2.LuaError("'" + fun + "' not implemented for " + typename());
    }


    protected LuaValue illegal(String op, String typename) {
        throw new com.luaj.vm2.LuaError("illegal operation '" + op + "' for " + typename);
    }


    protected LuaValue lenerror() {
        throw new com.luaj.vm2.LuaError("attempt to get length of " + typename());
    }


    protected LuaValue aritherror() {
        throw new com.luaj.vm2.LuaError("attempt to perform arithmetic on " + typename());
    }


    protected LuaValue aritherror(String fun) {
        throw new com.luaj.vm2.LuaError("attempt to perform arithmetic '" + fun + "' on " + typename());
    }


    protected LuaValue compareerror(String rhs) {
        throw new com.luaj.vm2.LuaError("attempt to compare " + typename() + " with " + rhs);
    }


    protected LuaValue compareerror(LuaValue rhs) {
        throw new com.luaj.vm2.LuaError("attempt to compare " + typename() + " with " + rhs.typename());
    }
    ...
    public static final boolean eqmtcall(LuaValue lhs, LuaValue lhsmt, LuaValue rhs, LuaValue rhsmt) {
        LuaValue h = lhsmt.rawget(String.valueOf(EQ));
        return h.isnil() || h != rhsmt.rawget(String.valueOf(EQ)) ? false : h.call(lhs, rhs).toboolean();
    }
    ...
    protected LuaValue checkmetatag(LuaString tag, String reason) {
        LuaValue h = this.metatag(tag);
        if (h.isnil())
